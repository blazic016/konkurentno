...
void* delay_timer (void *param)
{
    globalna--;
    printf("count delay: %d\n", globalna);
    return 0;
}
...
int main (void)
{
	...
	timer_event_set(&hDelayTimer, 1000, delay_timer, 0, TE_KIND_REPETITIVE);
